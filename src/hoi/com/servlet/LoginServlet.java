...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(1+ StudentID + PassWord);
		...
		if (StudentID == null || PassWord == null || StudentID.length() == 0 || PassWord.length() == 0) {
			hasError = true;
			...
			try {
				// Tìm user trong DB.
				user = DBUtils.findUser(conn, StudentID, PassWord);
		...
		if (hasError) {
			...
			System.out.println(2 + StudentID + PassWord);
